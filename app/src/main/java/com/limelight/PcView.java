...
public class PcView extends Activity implements AdapterFragmentCallbacks {
    ...
    private void doPair(final ComputerDetails computer) {
        if (computer.state == ComputerDetails.State.OFFLINE || computer.activeAddress == null) {
            StereoToast.makeText(PcView.this, getResources().getString(R.string.pair_pc_offline), StereoToast.LENGTH_SHORT).show();
            return;
        }
        if (managerBinder == null) {
            StereoToast.makeText(PcView.this, getResources().getString(R.string.error_manager_not_running), StereoToast.LENGTH_LONG).show();
            return;
        }

        StereoToast.makeText(PcView.this, getResources().getString(R.string.pairing), StereoToast.LENGTH_SHORT).show();
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (toastMessage != null) {
                            StereoToast.makeText(PcView.this, toastMessage, StereoToast.LENGTH_LONG).show();
                        }
    ...
    private void doWakeOnLan(final ComputerDetails computer) {
        if (computer.state == ComputerDetails.State.ONLINE) {
            StereoToast.makeText(PcView.this, getResources().getString(R.string.wol_pc_online), StereoToast.LENGTH_SHORT).show();
            return;
        }

        if (computer.macAddress == null) {
            StereoToast.makeText(PcView.this, getResources().getString(R.string.wol_no_mac), StereoToast.LENGTH_SHORT).show();
            return;
        }
    ...
    private void doUnpair(final ComputerDetails computer) {
        if (computer.state == ComputerDetails.State.OFFLINE || computer.activeAddress == null) {
            StereoToast.makeText(PcView.this, getResources().getString(R.string.error_pc_offline), StereoToast.LENGTH_SHORT).show();
            return;
        }
        if (managerBinder == null) {
            StereoToast.makeText(PcView.this, getResources().getString(R.string.error_manager_not_running), StereoToast.LENGTH_LONG).show();
        ...
        StereoToast.makeText(PcView.this, getResources().getString(R.string.unpairing), StereoToast.LENGTH_SHORT).show();
        new Thread(new Runnable() {
            @Override
            public void run() {
                NvHTTP httpConn;
