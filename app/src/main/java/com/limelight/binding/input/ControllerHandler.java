...
public class ControllerHandler implements InputManager.InputDeviceListener, UsbDriverListener {
    ...
    class GenericControllerContext {
        ...
        public void toggleMouseEmulation() {
            ...
            StereoToast.makeText(activityContext, "Mouse emulation is: " + (mouseEmulationActive ? "ON" : "OFF"), StereoToast.LENGTH_SHORT).show();
    ...
    class InputDeviceContext extends GenericControllerContext {
        ...
        public void sendControllerArrival() {
            ...
            if (type != MoonBridge.LI_CTYPE_PS && sensorManager != null) {
                ...
                StereoToast.makeText(activityContext, activityContext.getResources().getText(R.string.toast_controller_type_changed), StereoToast.LENGTH_LONG).show();
